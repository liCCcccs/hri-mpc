...
from mpc.env_dx.hri_ode_hddq2 import func as hri_ode_hddq2  # Import the Cython function
from mpc.env_dx.hri_ode_rddd2 import func as hri_ode_rddd2  # Import the Cython function
from mpc.env_dx.hri_ode_rddd3 import func as hri_ode_rddd3  # Import the Cython function
from mpc.env_dx.hri_ode_rddq4 import func as hri_ode_rddq4  # Import the Cython function
from mpc.env_dx.hri_ode_rddq5 import func as hri_ode_rddq5  # Import the Cython function
...
class HRIDx(nn.Module):
    ...
    def forward(self, x, u):
        ...
        new_h_dq2 = h_dq2 + self.dt * hddq2
        new_r_d2 = r_d2 + self.dt * r_dd2
        new_r_dd2 = r_dd2 + self.dt * rddd2
        new_r_d3 = r_d3 + self.dt * r_dd3
        new_r_dd3 = r_dd3 + self.dt * rddd3
        new_r_q4 = r_q4 + self.dt * r_dq4
        new_r_dq4 = r_dq4 + self.dt * rddq4
        new_r_q5 = r_q5 + self.dt * r_dq5
        new_r_dq5 = r_dq5 + self.dt * rddq5
